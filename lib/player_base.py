...
class Player:
    ...
    def __init__(self, positions):
        self.ships = {ship_type: PlayerShip(ship_type, position) #self.ships.values() : PlayerShip(ship_type, position)が返ってくる
                      for ship_type, position in positions.items()} #positions = {"w": [0, 0], "c": [0, 1], "s": [1, 0]}
